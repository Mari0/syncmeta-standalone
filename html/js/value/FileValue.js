/*global define, CONFIG, openapp, y */
define([
    'jqueryui',
    'jsplumb',
    'lodash',
    ...
    'text!../../templates/file_value.html',
    'text!../../templates/attribute/file_value.html'
],/** @lends FileValue */function($,jsPlumb,_,AbstractValue,AbstractAttribute,ValueChangeOperation,ActivityOperation,fileValueHtml, attributeFileValueHtml) {
