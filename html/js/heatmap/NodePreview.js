...
define([
    'jquery',
    'text!../../templates/heatmap/heatspot.html',
    'classjs'
], function ($, heatspotHtml) {
    ...
    return Class.extend({
        ...
        draw: function () {
            this.$node.css({
                top: this.originalY * this.scaleFactor.height,
                left: this.originalX * this.scaleFactor.width,
                width: this.originalWidth * this.scaleFactor.width,
                height: this.originalHeight * this.scaleFactor.height
            });
        },
