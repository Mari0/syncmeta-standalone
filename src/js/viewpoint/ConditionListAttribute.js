define([
    ...
    'viewpoint/ConditionPredicateAttribute',
    'text!../../templates/list_attribute.html'
],/** @lends ConditionListAttribute */function ($, jsPlumb, _, Util, AttributeAddOperation, AttributeDeleteOperation, AbstractAttribute, ConditionPredicateAttribute, listHtml) {
