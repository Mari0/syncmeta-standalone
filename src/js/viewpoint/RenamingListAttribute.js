define([
    ...
    'viewpoint/RenamingAttribute',
    'text!../../templates/list_attribute.html'
],/** @lends RenamingListAttribute */function($,jsPlumb,_,Util,AttributeAddOperation,AttributeDeleteOperation,AbstractAttribute,RenamingAttribute,listHtml) {
