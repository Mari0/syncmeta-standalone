...
define([
    ...
    function AbstractEdge(id, type, source, target, overlayRotate) {
        ...
        var _$browserNode = $(_.template(abstractEdgeBrowserHtml, { id: id, type: type }));
        ...
        this.addToCanvas = function (canvas) {
            _canvas = canvas;
             //add edge to property browser
             var attributeBrowser = _canvas.getAttributeBrowser();
             attributeBrowser.get$node().append(this.get$BrowserNode());
        ...
        /**
         * Get jQuery object of DOM node representing the edge in the property browser
         * @returns {jQuery}
         * @private
         */
        ...
        this.connect = function () {
            ...
            //add edge to property browser
            var attributeBrowser =this.getCanvas().getAttributeBrowser();
        ...
        this.remove = function () {
            ...
            require('EntityManager').deleteEdge(this.getEntityId());
            if (_ymap) {
                _ymap = null;
            }
        };
