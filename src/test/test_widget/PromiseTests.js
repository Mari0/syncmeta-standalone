/*global requirejs, define, describe, it, before, after, openapp, CONFIG*/
    ...
    function PromiseTest() {
        ...
        describe('Promise Test', function() {
            ...
            before(function(done) {
                ...
                $.when(insertModelToSpace(CONFIG.NS.MY.METAMODEL, model), insertModelToSpace(CONFIG.NS.MY.MODEL, model)).done(function() {
                    done();
                });
            });
            ...
            describe('Native promise Test', function() {
                ...
                before(function(done) {
                    var d = done;
                    requirejs(['lib/vendor/test/chai',
                        'Space',
                        'Model',
                        'Metamodel',
                        'Guidancemodel'], function(chai, Space, Model, Metamodel, Guidancemodel) {
                            spaceP = Space;
                            modelP = Model;
            ...
            describe('Requirejs-promise Test', function() {
                ...
                before(function(done) {
                    ...
                    requirejs(['lib/vendor/test/chai', 'promise!Space',
                        'promise!Model',
                        'promise!Metamodel',
                        'promise!Guidancemodel'], function(chai, Space, Model, Metamodel, Guidancemodel) {
            ...
            after(function(done) {
                ...
                $.when(cleanSpace(CONFIG.NS.MY.METAMODEL), cleanSpace(CONFIG.NS.MY.MODEL)).done(function() {
                    done();
                });
            })
        })
